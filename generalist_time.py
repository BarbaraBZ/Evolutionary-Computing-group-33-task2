...
mutation = 0.25          # mutation rate
tournament_size = 4     # tournament size for survivor selection
...
# mutate an individual with time-dependent mutation
